...
namespace ExifReader
{
    ...
    public class ExifReaderException : Exception
    {
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("PropertyFormatter", this.PropertyFormatter, typeof(IExifPropertyFormatter));
            info.AddValue("UndefinedExtractor", this.UndefinedExtractor, typeof(IExifValueUndefinedExtractor));
        }
    }
}
